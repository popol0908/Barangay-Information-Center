                    ...
                    return (
                      <tr key={event.id}>
                        ...
                        <td>
                          ...
                          >
                            <span className="btn-registrations-icon">👥</span>
            ...
            <div className="modal-overlay" onClick={() => setShowRegistrationsModal(false)}>
              <div className="modal-dialog large-modal registrations-modal" onClick={e => e.stopPropagation()}>
                <div className="modal-header registrations-modal-header">
                  ...
                  <button className="modal-close" onClick={() => setShowRegistrationsModal(false)}>✖️</button>
                </div>
                          ...
                          <div key={registration.id} className="registration-card">
                            ...
                            <div className="registration-responses">
                              <div className="responses-header">
                                <span className="responses-title">📝 Registration Details</span>
                              </div>
                                      ...
                                      <div key={field.id} className="response-item">
                                        <label className="response-label">
                                          <span className="response-label-icon">
                                            {field.type === 'dropdown' ? '📋' : field.type === 'textarea' ? '📄' : field.type === 'number' ? '🔢' : '✏️'}
                                          </span>
                                          {field.label}
          ...
          {showDeleteDialog && (
            <div className="modal-overlay" onClick={() => setShowDeleteDialog(false)}>
              <div className="delete-dialog" onClick={e => e.stopPropagation()}>
                <h3 className="dialog-title">⚠️ Delete Event</h3>
