...
const PendingVerification = () => {
  ...
  const lockedFeatures = [
    { icon: '🏠', name: 'Home', description: 'Dashboard and resident services', locked: true },
    { icon: '🚨', name: 'Emergency Alerts', description: 'Real-time emergency notifications', locked: true }
  ];

  const availableFeatures = [
    { icon: '📢', name: 'Announcements', description: 'View public announcements', locked: false },
    { icon: '👥', name: 'Officials', description: 'View barangay officials', locked: false }
  ];
        ...
        <div className="pending-wrapper">
          ...
          <div className="features-section">
            ...
            <div className="features-group">
              <h3 className="group-title">🔒 Locked Until Verified</h3>
            ...
            {/* Available Features */}
            <div className="features-group">
              <h3 className="group-title">✅ Available Now</h3>
              <div className="features-grid">
          ...
          <div className="info-section">
            <div className="info-card">
              <h3 className="info-title">📋 What's Being Verified?</h3>
            ...
            <div className="info-card">
              <h3 className="info-title">⏱️ How Long Does It Take?</h3>
